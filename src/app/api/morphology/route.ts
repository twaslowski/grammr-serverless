...
const MORPHOLOGY_API_URL = process.env.MORPHOLOGY_API_URL;
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!MORPHOLOGY_API_URL) {
      console.error("MORPHOLOGY_API_URL not configured");
    ...
    const response = await fetch(`${MORPHOLOGY_API_URL}/morphology`, {
      method: "POST",
      headers: {
